...
function renderizarPaginaClientes() {
  ...
  if (pagina.length === 0) {
    ...
    pagina.forEach(cliente => {
      ...
      linha.innerHTML = `
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${cliente.cpf || ''}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${cliente.cnpj || ''}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${cliente.cliente}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${cliente.e_mail || ''}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${cliente.telefone || ''}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${cliente.cidade || ''}</td>
