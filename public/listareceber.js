...
function renderizarPaginaReceber() {
  ...
  if (paginaDados.length === 0) {
    ...
    paginaDados.forEach(r => {
      ...
      linha.innerHTML = `
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${r.controle}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${r.funcionario}</td>
        <td style="font-size: 12px;border:1px solid #ccc;">${r.nomecliente}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: right;">R$ ${parseFloat(r.valororiginal).toFixed(2)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: right;">R$ ${parseFloat(r.valorpago).toFixed(2)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${r.numeroparcela}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${r.totalparcelas}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${formatarDataBRL(r.datacadastro)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${formatarDataBRL(r.datavencimento)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${r.datapagamento ? formatarDataBRL(r.datapagamento) : 'PENDIENTE'}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: right;">${parseFloat(r.multa).toFixed(2)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: right;">${parseFloat(r.juros).toFixed(2)}</td>
        <td style="font-size: 12px;border:1px solid #ccc;text-align: center;">${r.status}</td>
